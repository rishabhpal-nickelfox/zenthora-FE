...
import {ShippingInfoLabels} from './shipping-info-labels';
...
@Component({
  standalone: false,
  selector: 'app-invoice-email-payment-template-shipping-info-edit',
  templateUrl: './shipping-info-edit.component.html',
  styleUrls: ['./shipping-info-edit.component.scss', '../../../../../modals/external-modal.scss'],
  providers: [FormPageStateService],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ShippingInfoEditComponent extends FormPageComponent implements OnInit {
  ...
  readonly Labels = ShippingInfoLabels;
  ...
  private _viewService: ShippingInfoViewService;

  public get viewService(): ShippingInfoViewService {
    return this._viewService;
  }

  public set viewService(value: ShippingInfoViewService) {
  ...
  protected onReInit() {
    ...
    this._shipMethodHeader.reset(this.viewService.shipMethodHeader);
    this._trackingNumberHeader.reset(this.viewService.trackingNumberHeader);
    this._shipDateHeader.reset(this.viewService.shipDateHeader);
  ...
  protected onSubmit({value}: { value: any }) {
    this.viewService.shipMethodHeader = this._shipMethodHeader.value;
    this.viewService.trackingNumberHeader = this._trackingNumberHeader.value;
    this.viewService.shipDateHeader = this._shipDateHeader.value;
  ...
  private updateStyles() {
    this.styles = this.htmlSanitizer.trustHtml(`
                  <style>
                      ...
                      app-invoice-email-payment-template-shipping-info-edit {
