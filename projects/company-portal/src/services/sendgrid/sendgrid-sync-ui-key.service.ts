...
@Injectable()
export class SendgridSyncUiKeyService extends CompanyBaseUiKeyService {

  constructor(protected currentDataService: CompanyCurrentDataService) {
    super(currentDataService);
  }

  showSendgridSyncAudit() {
    return this.userCurrentRoleContainsPermissions(UiKeyEnum.SYSTEM_SENDGRID_AUDIT);
  }
}
