...
export class InvoicePaymentComponent extends SalePortalPaymentComponent implements OnInit {
  ...
  @ViewChild("printSale", {read: ElementRef, static: false}) private _printSale: ElementRef;
